...
- IoT Devices Registry Service (регистрация умных устройств)
- IoT Devices Health Check (контроль состояния умных устройств)
- Sensors Telemetry Service (сбор и хранение показаний)
- CCTV Service (видеонаблюдение)
- Heating Management (управление отоплением)
- Lighting Management (управление освещением)
- Gates Management (управление воротами)
- Use Cases Management (регистрация, хранение, выполнение сценариев использования)
- User Account (управление аккаунтами пользователей)
- User Notification (сервис уведомлений)

Служебные:
- Health Check Service (контроль состояния сервисов)
- Analysis Service (ана)
